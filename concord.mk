...
concord_pass:
	llvm-link-10 -o libleveldb.bc $(BUILD_DIR)/*.bc
	llvm-dis-10 libleveldb.bc -o leveldb.ll
	...
	$(CXX) -c -O3 concord_leveldb.rdtsc.opt.ll -o concord_libleveldb_rdtsc.a
	$(CXX) -c -O3 leveldb.ll -o concord_libleveldb_clear.a
